...
const RecognitionStartPage = () => {
  ...
  const handleNextClick = () => {
      navigate(`/round/${roundNumber}/recognition`); // 한국어 뜻 적기 페이지로 이동
  };

  // 현재 활성 스텝
  const activeStep = "한국어 뜻 적기"; // 활성 스텝 변경

  return (
    <MainLayout>
       {/* LearningStartPage와 동일한 스타일 사용 */}
      <style>{`
        ...
        .start-button-wrapper { /* 클래스명 유지 또는 next-button-wrapper로 변경 가능 */
          display: flex;
